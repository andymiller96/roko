...
import com.kendrick.angularspringboot.roko.repository.EmployeeRepository;
...
public class EmployeeController {
    ...
    public ResponseEntity<Employee> updateEmployee(@PathVariable(value = "id") final Long employeeId,
            @Valid @RequestBody final Employee employeeDetails) throws ResourceNotFoundException {
        Employee employee = employeeRepository.findById(employeeId)
            .orElseThrow(() -> new ResourceNotFoundException("Employee not found for this id :: " + employeeId));        
